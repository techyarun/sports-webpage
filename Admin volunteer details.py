...
q="""select * from volunteer"""                                                     #to get all details
cur.execute(q)
r=cur.fetchall()
count=0
print("""                                                                           #HTML and css
    ...
    <th>password</th><th>profile</th><th>change</th><th>remove</th>
    </tr>""")
for i in r:                                                                        #loops to get details of volunteer
    count=count+1
    print("""
    <td>%s</td>
    <td>%s</td>
    ...
    <td><a href="adminvolunteerchange.py?cid=%s&id=%s">change</a></td>
