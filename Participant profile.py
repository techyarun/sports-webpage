...
q = """select * from participant where id=%s"""%(id)                                    #fetching details of particular user
cur.execute(q)
r = cur.fetchone()
print("""                                                                               #html and css
<html>
...
<div class="table">
<table style="border:3px solid cyan">
...
<tr><td><b>GAME</b>: %s</td></tr>
<tr><td><b>BLOODGROUP</b>: %s</td></tr>
...
""" %(r[2],r[11],r[1],r[2],r[3],r[4],r[5],r[6],r[7],r[8],r[9],r[10]))
conn.close()
